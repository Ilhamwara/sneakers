				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table table-hover" style="text-align:center;">
							...
							$show = mysql_query("SELECT pemesanan.id, member.nama,barang.nama_barang,pemesanan.harga,pemesanan.qty,pemesanan.status, pemesanan.tanggal FROM pemesanan INNER JOIN member ON pemesanan.id_user=member.id INNER JOIN barang ON pemesanan.id_barang=barang.id WHERE pemesanan.status='1' LIMIT $start, $per_page");
